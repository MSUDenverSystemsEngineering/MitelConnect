...
Try {
	...
	[string]$appVendor = ''
	[string]$appName = 'Mitel Connect'
	[string]$appVersion = ''
	[string]$appArch = 'x64'
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.0'
	[string]$appScriptDate = '01/03/2023'
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		Show-InstallationWelcome -CloseApps 'Mitel,Outlook' -CheckDiskSpace -PersistPrompt
		...
		$exitCode = Execute-Process -Path "$dirFiles\MitelConnect.exe" -Parameters "/S /v/qn" -WindowStyle "Hidden" -PassThru
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Show-InstallationWelcome -CloseApps 'Mitel,Outlook' -CloseAppsCountdown 60
		...
		$exitCode = Execute-Process -Path "$dirFiles\MitelConnect.exe" -Parameters "/s /x /v/qn" -WindowStyle "Hidden" -PassThru
		If (($exitCode.ExitCode -ne "0") -and ($mainExitCode -ne "3010")) { $mainExitCode = $exitCode.ExitCode }

		#Uninstall Mitel Presenter
		Remove-MSIApplications -Name "Mitel Presenter"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCB0QuhNPlbWs9fR
# /h1twdtS+EQYKO/5MdQaJ9bkc+k97aCCH8EwggVvMIIEV6ADAgECAhBI/JO0YFWU
...
# AYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQg3FDMb52Asqq2
# wGS4NjTImYF8UraeyUkCX4bfhZo+l44wDQYJKoZIhvcNAQEBBQAEggGAIxdnq7Ir
# JUyS7h5vFb46xbvarJxAr8LRJJoDMpRZacpNfvmLaHQIys6bRDL2j0JNofXUeGMI
# jgwzo7KxfbY5w2qPiC6KFCwFZ5ZSlufBtWcA3z1K24ttuKffmLMq5E18ObXDbZ0e
# gWGSGWbUy51LcBM1kQRjyC3kBE3Gmk9xCA36txGcPZjbjyvQ9NwsMtPoJraE/LhH
# zZm0w3QI/2ZmMD7bYE0saExh+H46D+j0jmj72xJLkJSJuBAQ6IBUx7TXp7j/CBMA
# natXaIR4NSaN/NiV+n56pnnK+8vNuMMg3/JTXvwYj0ONRFoe+VM+Py7AEujkbd5U
# indwEYyagNLHY3d8LWkhEONNIJxJvoMsYyV+nInqhnhFyl0V/RD03VC63fr6WgX7
# Pi8sB+UpqAXyit8r4fjUtbZADucFQtdeHEQBxP4kprJkmZe7iVGi0PUyxskdGlNJ
# Jp9s3ytI0oG2Tc2wzTzk34F/d6bmoO296dkec4l34w7eAR3zwUgl1okkoYIDTDCC
...
# BgkqhkiG9w0BCQMxCwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0yMzAxMDMy
# MDU3MTVaMD8GCSqGSIb3DQEJBDEyBDDaUxn3ZM8/3TePNW7UsG3e87lOG8YifF/w
# pXcryPY07K/iC4h5SsU8xH4Mrzxgta8wDQYJKoZIhvcNAQEBBQAEggIAHbIRGmrQ
# sR50iqu6NsjhE7sC8ohtVEBVZjUooOWQd15trcSslIC1ZL9Ktu+0Zmq5awmhdOcz
# cqNEoRzugvKjvbKQquVGnTKls/VXfPr3JImXVwO77Nevl7r6WahIthXQpAxx/cZS
# 2/sLTLk9Fzbih5DXgJp7Vd2KDkeqtiT8aRKnvRomnp1F/9RrFngQPBZdWwK0NH03
# noOQVBA0z9xp4mkRCspnkYz8oFlr9ToZ/8QkvmO99WTAGc1gBCweYV/YfVz/3KAI
# f1kpwMJAAXIX3hfCgn1meub3ClVGKydjICco6YAtf5GP59DVrzuPadMZPNeUaVR5
# JfiZnVs22lvM9AfT34Z5dlmGWM9fn5wJA287yIFNBjCnXgD7nPzcd0BgOwB5yIkp
# +AtQqdEYqR4HeR9uyRjX5khaFXOElEdfICcmUYCnLGfKAFSbdO/QNL4UhNe7LhgI
# PELncqPPch9/NU0C+fjrOuDrBl+Hcy+ZEkpUMFpLxMlyaDhKGXPmbRgWhbZ15zAN
# iHB2BY/zAkwuVbd4MNJGCHQMMDFj0fiMkHWO6J1zLvQpKE/HGjKMJ9hYmviFSLWY
# AmLTUeBWToPCrsSTSshnYYdlTb2s8ypnSRkLJvxDbvoy8VRykDw4/sW1x8ttsmno
# KCIWUkr0AqSaUb8UQATdCdQizlMHlMa7bF8=
